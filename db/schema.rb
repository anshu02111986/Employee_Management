...
ActiveRecord::Schema[7.1].define(version: 2023_10_30_041952) do
  create_table "employments", charset: "latin1", force: :cascade do |t|
  ...
  create_table "personal_data", charset: "latin1", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email_address"], name: "index_personal_data_on_email_address", unique: true
  end
